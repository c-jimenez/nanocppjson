...
std::span<char> generate_object_end(const std::span<char>& buffer, bool has_next_value)
{
    std::span<char> left = add_char('}', buffer);
    if (has_next_value)
    {
        left = add_char(',', left);
    }
...
std::span<char> generate_array_end(const std::span<char>& buffer, bool has_next_value)
{
    std::span<char> left = add_char(']', buffer);
    if (has_next_value)
    {
...
std::span<char> generate_value(const std::string_view& name, const std::span<char>& buffer, bool has_next_value)
{
    std::span<char> left;
...
std::span<char> generate_value(const std::string_view& name, bool value, const std::span<char>& buffer, bool has_next_value)
{
    std::span<char> left;
    std::span<char> left_name = add_member_name(name, buffer);
...
std::span<char> generate_value(const std::string_view& name,
...
std::span<char> generate_value(const std::string_view& name, json_int_t value, const std::span<char>& buffer, bool has_next_value)
{
    std::span<char> left;
    std::span<char> left_name = add_member_name(name, buffer);
...
std::span<char> generate_value(const std::string_view& name, json_float_t value, const std::span<char>& buffer, bool has_next_value)
{
    std::span<char> left;
    std::span<char> left_name = add_member_name(name, buffer);
